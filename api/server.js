...
const pool  = new Pool({ connectionString: process.env.DATABASE_URL || 'postgresql://postgres.dakleqewbwbryuchlrzm:LKB2DWbWbc60fZXh@aws-0-eu-west-1.pooler.supabase.com:6543/postgres', ssl: { rejectUnauthorized: false } });
