...
async function initDB() {
  try {
    ...
    await query(`CREATE TABLE IF NOT EXISTS utilizadores (
    ...
    await query(`CREATE TABLE IF NOT EXISTS turno_stock (
    ...
    await query(`CREATE TABLE IF NOT EXISTS turno_caixa (
    ...
    // always add missing columns (idempotent)
    ...
    // always upsert admin and products
    await query(`INSERT INTO utilizadores (nome,email,senha_hash,role) VALUES ('Admin','admin@stockos.ao',$1,'admin') ON CONFLICT (email) DO UPDATE SET senha_hash=$1`, [hashPassword('admin123')]);
